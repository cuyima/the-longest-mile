...
function CleanJson {
    ...
    $jsonObject = $jsonObject | Select-Object -ExcludeProperty _stats, flags, system.schema, ownership, _key
    $jsonObject.system = $jsonObject.system | Select-Object -ExcludeProperty schema, _migration, source
    $jsonObject.system.description = $jsonObject.system.description | Select-Object -ExcludeProperty  gm
